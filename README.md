...
```ts
import Route from "https://deno.land/x/routets@v3.1.0/Route.ts"
...
```sh
$ deno install -gAf https://deno.land/x/routets@v3.1.0/routets.ts
...
```ts
import Router from "https://deno.land/x/routets@v3.1.0/Router.ts"
